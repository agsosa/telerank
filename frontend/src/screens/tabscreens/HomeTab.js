      ...
      return (
        <View style={{padding: 10}}>
            <Banner
                ...
                Agrega tu canal, grupo, bot o sticker de Telegram al directorio gratis! <Text style={{color:'#2196F3', fontWeight:'bold', textDecorationLine:'underline'}}>Tap here</Text>
            </Banner>
