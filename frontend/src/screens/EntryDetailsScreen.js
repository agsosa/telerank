      ...
      <View style={{ zIndex:99, top:'-28%', flex: 1, marginBottom:"-30%", marginHorizontal:-5 }}>
        <ScrollView centerContent style={{height:50}} contentContainerStyle={{alignSelf:'center'}}>
          <Card key={data._id} style={{width:'90%', flex: 1}}>
            <CardItem bordered>
              <Left>
                ...
                <Body>
                  ...
                  <Text note>{data.type} / {data.category} / {formatLanguageCode(data.language)}</Text>
                </Body>
              </Left>
            ...
            <Button style={{backgroundColor:'#2196F3', paddingVertical:3, marginHorizontal:30, marginVertical:10}}><Icon name='paper-plane' style={{color:'white'}}/><Text style={{color:'white', fontSize:20}}>Abrir en Telegram</Text></Button>
