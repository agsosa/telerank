...
function getCategoryFromLocaleString(localeStr) {
    if (localeStr) {
        ...
        return keys.find((q) => index_1.isMatch(latinize(exports.Categories[q].es.toLowerCase()), str) || index_1.isMatch(latinize(exports.Categories[q].en.toLowerCase()), str)) || 'NO_CATEGORY';
    }
    return 'NO_CATEGORY';
}
